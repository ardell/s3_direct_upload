  ...
  $.fn.S3Uploader = function(options) {
    ...
    setUploadForm = function() {
      return $uploadForm.find("input[type='file']").fileupload({
        ...
        progress: function(e, data) {
          ...
          if (data.context && settings.remove_completed_progress_bar) { // remove progress bar
            data.context.remove();
          }
        ...
        fail: function(e, data) {
          ...
          if (data.context && settings.remove_failed_progress_bar) { // remove progress bar
            data.context.remove();
          }
    ...
    build_content_object = function($uploadForm, file, result) {
      ...
      if (result) { // Use the S3 response to set the URL to avoid character encodings bugs
        ...
        content.filepath = $('<a />').attr('href', content.url)[0].pathname; // IE <= 9 retu      rn a null result object so we use the file object instead
      } else {
